...
import {
    ...
    Users, Leaf, ShoppingCart, TrendingUp
} from 'lucide-react'
                ...
                <div className="text-center max-w-6xl mx-auto">
                    <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
                        ...
                        <h1 className="text-5xl md:text-7xl font-bold mb-6">
                            Turn Your <span className="bg-gradient-to-r from-orange-500 to-pink-500 bg-clip-text text-transparent">{data.highlightedWord}</span>
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
                            ...
                            <Button size="lg" variant="outline" className="px-8 py-6 rounded-full text-lg border-2 hover:bg-gray-50">
                    ...
                    <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
                        {data.steps.map((step: any, i: number) => {
                            ...
                            return (
                                ...
                                >
                                    <div className={`w-16 h-16 ${colors[i]} rounded-full flex items-center justify-center mx-auto mb-4`}>
